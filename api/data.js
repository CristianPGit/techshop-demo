// In-memory data store — resets on server restart (intentional for testing demos)
...
// Session-keyed carts: { [sessionId]: { items: [], updatedAt } }
const carts = {};

// Orders store: { [orderId]: Order }
const orders = {};

// Active sessions (from login): { [token]: { email, name, loginAt } }
const sessions = {};

const DEMO_USERS = [
  { email: 'demo@techshop.com', password: 'password123', name: 'Demo User' },
  { email: 'qa@techshop.com', password: 'qa1234', name: 'QA Engineer' },
];

module.exports = { PRODUCTS, carts, orders, sessions, DEMO_USERS };
